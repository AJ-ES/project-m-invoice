...
function Invoiceview() {
  ...
  const interStateTax = invoice
    ? parseInt(invoice.companydetails.companypincode) ===
      parseInt(invoice.buyerdetails.buyercompanystatecode)
      ? false
      : true
    : false;
  ...
  if (
    ...
    invoice.consignmentdetails.itemdetails.length > 0
  ) {
    invoice.consignmentdetails.itemdetails.forEach((item, index) => {
      itemQuantitySum += item.itemquantity;
      const itemAmount =
        Math.round(item.itemprice * item.itemquantity * 100) / 100;
  ...
  if (invoice && invoice.consignmentdetails) {
    ...
    totalAmountTax = invoice.consignmentdetails.itemdetails.reduce(
      (total, item) => {
          ...
          <div class="container original">
            ...
            <div class="content">
                ...
                <div class="d-flex">
                  ...
                  <div class="comAddress">
                    <p class="companyname1">
                      <b>{invoice.companydetails.companyname}</b>
                      <br />
                      {invoice.companydetails.companyofficeaddress} <br />
                      GSTIIN/UN : {invoice.companydetails.companygstno} <br />
                      State Name : {invoice.companydetails.companystate}, Code :{" "}
                      {invoice.companydetails.companypincode}
                    </p>
                  </div>
                </div>
              ...
              <div class="section1  d-flex">
                <div class="s1-part1">
                  <div class="left">
                    <b>Invoice No</b>: {invoice.invoicedetails.invoiceid} &nbsp;
                  </div>
                  <div>
                    <p class="alignleft mb-1">
                      <b>BUYER</b> (if other than Consignee)
                      <br />
                      {invoice.buyerdetails.buyercompanyname.toUpperCase()}{" "}
                      <br />
                      {invoice.buyerdetails.buyercompanyaddress}
                      <br />
                      GSTIN/UIN : {invoice.buyerdetails.buyercompanygstno}{" "}
                      <br />
                      State Name : {invoice.buyerdetails.buyercompanystatename},
                      Code : {invoice.buyerdetails.buyercompanystatecode}
                    </p>
                  </div>
                </div>
                <div class="s1-part2">
                  <div class="right">
                    <b>Date</b>: {formattedDateStr} &nbsp;
                  </div>
                  <div>
                    <p class="alignright mb-1">
                      <b>Consignee</b> <br />
                      {invoice.sellerdetails.sellercompanyname.toUpperCase()}{" "}
                      <br />
                      {invoice.sellerdetails.sellercompanyaddress}
                      <br />
                      GSTIN/UIN : {invoice.sellerdetails.sellercompanygstno}
                      <br />
                      State Name :{" "}
                      {invoice.sellerdetails.sellercompanystatename}, Code :{" "}
                      {invoice.sellerdetails.sellercompanystatecode}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="section2">
                <div class="line-text">
                  ...
                  <b>Load From </b> :{invoice.loadingdetails.startpoint}&nbsp;{" "}
                  <b>To </b> :{invoice.loadingdetails.endpoint}
                  &nbsp;&nbsp;&nbsp;<b>Ref. </b>:
                ...
                <table className="table01">
                  ...
                  <tbody>
                      ...
                      <td className="text-end">
                        ...
                        {interStateTax === false ? (
                          <div>
                            ...
                            <br />
                            {adjustedValue.toFixed(2) < 0 ? "(-)" : "(+)"}
                            {Math.abs(adjustedValue.toFixed(2))}
                          </div>
                        ) : (
                          <div>
                            {commaNumber(
                              ((18 / 100) * itemAmountSum).toFixed(2)
                            )}
                            <br />
                            {adjustedValue.toFixed(2) < 0 ? "(-)" : "(+)"}
                            {Math.abs(adjustedValue.toFixed(2))}
                    ...
                    <tr className="cus_tr">
                      ...
                      <td></td>
                      <td className="text-end">
                        {commaNumber(totalAmount.toFixed(2))}
                      </td>
                    </tr>
                    <tr className="cus_tr">
                      <td colSpan="2">
                        <div className="amtword">
                ...
                <table className="table2">
                  <thead>
                    ...
                    <tr>
                      ...
                      <th></th>
                      <th></th>
                      <th colSpan="2" className="al-center">
                        CGST
                      </th>
                      <th colSpan="2" className="al-center">
                        SGST
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <th className="text-end">
                        {commaNumber(totalAmountTax.toFixed(2))}
                      </th>
                    </tr>
                    <tr className="cus_tr">
                      <td colSpan="3">
